...
users_gateway_grpc_client = build_users_gateway_grpc_client()
...
open_credit_card_account_response = accounts_gateway_grpc_client.open_credit_card_account(user_id = create_user_response.user.id)
print('Open credit card account response:', open_credit_card_account_response)

get_tariff_document_response = documents_gateway_grpc_client.get_tariff_document(account_id = open_credit_card_account_response.account.id)
print('Get tariff document response:', get_tariff_document_response)

get_contract_document_response = documents_gateway_grpc_client.get_contract_document(account_id = open_credit_card_account_response.account.id)
