...
the [Performance QA Engineer Course](https://github.com/et891/performance-tests) stand — a
...
the [course infrastructure repository](https://github.com/et891/performance-tests).
